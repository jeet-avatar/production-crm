    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#161625] rounded-[40px] shadow-2xl border-4 border-black w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 border-b border-[#2a2a44] bg-[#12121f]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border-2 border-[#33335a] rounded-lg focus:outline-none focus:border-indigo-500"
                  required
                />
              </div>
          ...
          {error && (
            <div className="mt-4 p-3 bg-red-500/10 border border-red-200 rounded-lg text-red-400 text-sm">
              {error}
            </div>
          )}

          {infoMessage && (
            <div className="mt-4 p-3 bg-orange-500/10 border border-orange-200 rounded-lg text-orange-400 text-sm flex items-start gap-2">
          ...
          {loading ? (
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="text-[#94A3B8] font-medium">Searching for leads...</p>
              </div>
            </div>
          ) : leads.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {leads.map((lead, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-[#161625] border-2 border-[#2a2a44] rounded-xl p-4 hover:border-orange-300 hover:shadow-lg transition-all"
                  >
                    {/* Avatar/Logo */}
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-bold text-[#F1F5F9] truncate">
                    ...
                    {mode === 'company' && lead.leadScore && (
                      <div className="mb-3">
                        <span className="inline-flex items-center px-2 py-1 bg-orange-500/15 text-orange-400 rounded-full text-xs font-semibold">
                    ...
                    <div className="flex gap-2 mb-4">
                      {lead.LinkedinLink && (
                        <a
                          ...
                          className="text-xs text-indigo-400 hover:text-orange-400 flex items-center gap-1"
                        >
            ...
            <div className="text-center py-12">
              <MagnifyingGlassIcon className="w-16 h-16 text-[#64748B] mx-auto mb-4" />

...
async function sendTestEmail() {
  const recipient = { email: 'rajesh@techcloudpro.com', firstName: 'Rajesh', lastName: 'TechCloud' };
  ...
  console.log(`\n📊 Campaign Analytics: http://localhost:5173/campaigns/${campaign.id}/analytics`);

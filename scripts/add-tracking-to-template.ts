...
/**
 * This script adds comprehensive tracking to the email template:
 * 1. Tracking pixel for opens
 * 2. Click tracking for all links
 * 3. Individual CTA tracking
 */
...
🎥 SEE IT IN ACTION
[Watch Demo Video]
https://brandmonkz.com/api/tracking/click/{{emailLogId}}?url=${encodeURIComponent('https://brandmonkz-video-campaigns.s3.us-east-1.amazonaws.com/demo-videos/criticalriver-demo.mp4')}&cta=watch_video
...
https://brandmonkz.com/api/tracking/click/{{emailLogId}}?url=${encodeURIComponent('https://calendar.app.google/LiM5V1VPQrnGTLiV6')}&cta=schedule_demo
...
https://brandmonkz.com/api/tracking/click/{{emailLogId}}?url=${encodeURIComponent('https://www.criticalriver.com')}&cta=website
...
Unsubscribe: https://brandmonkz.com/unsubscribe?email={{email}}&campaignId={{campaignId}}`;
  ...
  console.log('\n✅ Email Template Updated with Comprehensive Tracking!');

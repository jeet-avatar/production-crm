...
- [ ] 06-05-PLAN.md — Wave 4 — Frontend Apollo Campaign button + Pending Review tab + apolloApi.unsentContacts + apolloApi.pendingReview.{list,approve,reject,edit} + PendingReviewQueue.tsx component. Uses static emailTemplatesApi.findByCategory('Stream:'+streamName) (NO space, NO dynamic import, NO placeholder). VALID_STREAMS_FRONTEND guard routes rogue stream values to 'Other' (REQ-064, REQ-065)

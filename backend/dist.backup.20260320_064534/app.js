...
const activityLogger_1 = __importDefault(require("./middleware/activityLogger"));
...
const calendar_auth_1 = __importDefault(require("./routes/calendar-auth"));
...
const videoCampaigns_1 = __importDefault(require("./routes/videoCampaigns"));
const super_admin_1 = __importDefault(require("./routes/super-admin"));
const ui_config_1 = __importDefault(require("./routes/ui-config"));
const ai_code_1 = __importDefault(require("./routes/ai-code"));
...
app.use('/api/calendar', calendar_auth_1.default);
app.use('/api', (0, securityGuards_1.applyAllSecurityGuards)());
app.use('/api', activityLogger_1.default);
...
app.use('/api/video-campaigns', videoCampaigns_1.default);
app.use('/api/super-admin', super_admin_1.default);
app.use('/api/ui-config', ui_config_1.default);
app.use('/api/ai-code', passport_1.default.authenticate('jwt', { session: false }), ai_code_1.default);

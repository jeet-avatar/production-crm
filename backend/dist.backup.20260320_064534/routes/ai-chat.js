...
const chatbot_openai_service_1 = require("../services/chatbot-openai.service");
...
router.post('/message', async (req, res, next) => {
    try {
        ...
        const response = await chatbot_openai_service_1.chatbotOpenAI.processRequest(message, {
            userId,
...
router.post('/approve', async (req, res, next) => {
    try {
        ...
        const result = await chatbot_openai_service_1.chatbotOpenAI.executeApprovedAction(action, data, userId);

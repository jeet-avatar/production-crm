...
/**
 * Seed the Critical River email template for all existing users
 * Run this script to add the template to the database
 *
 * Usage:
 * npx ts-node src/utils/seed-critical-river-template.ts
 */

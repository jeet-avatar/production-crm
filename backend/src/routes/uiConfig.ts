...
// NEW ENDPOINT - different path to test if /active is being intercepted
 ...
 * Returns the active UI configuration and theme
 * This endpoint is public (no authentication required) so the theme loads before login
 */
router.get('/active', (_req, res) => {
  // Simplified - just return the config directly without any complex logic
  res.status(200).json({
    theme: {

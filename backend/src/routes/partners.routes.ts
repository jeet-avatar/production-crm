...
// GET /api/partners/programs - Get all active partner programs (NO AUTH REQUIRED)
...
router.post('/apply', async (req: Request, res: Response) => {
  ...
  try {
    ...
    // Check for duplicate application (same email for same program)
...
partners@brandmonkz.com
    ...
    // Send notification email to admin (to support@brandmonkz.com or configured email)
    try {

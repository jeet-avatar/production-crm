...
exports.invokeClaudeStream = invokeClaudeStream;
...
exports.generateReplysuggestions = generateReplysuggestions;
exports.analyzeCampaignPerformance = analyzeCampaignPerformance;
...
async function invokeClaudeStream(params, onChunk) {
    const modelId = params.modelId || 'anthropic.claude-3-sonnet-20240229-v1:0';
    const payload = {
        anthropic_version: 'bedrock-2023-05-31',
        max_tokens: params.maxTokens || 4096,
...
async function summarizeContent(content, maxLength = 100) {
...
async function generateReplysuggestions(emailContent, context) {
